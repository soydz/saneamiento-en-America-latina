    ...
    public List<CountrySanitationStatistics> statisticsOfCountries() {
        ...
        List<CountrySanitationStatistics> countriesList =
                List.of(
                        ...
                        new CountrySanitationStatistics(
                                "Bolivia", 11216000, 61.9, 1600000, 1021, 400, 9.7),
                        new CountrySanitationStatistics(
                                "Chile", 17574003, 92.6, 958100, 3200, 98, 48.9),
                        new CountrySanitationStatistics(
                                "Venezuela", 32605423, 24.5, 10800000, 1207, 2100, 14.8),
                        new CountrySanitationStatistics(
                                "Haití", 11488792, 16.3, 950000, 420, 950, 5.2),
                        new CountrySanitationStatistics(
                                "Uruguay", 3286314, 97.9, 410, 3130, 45, 21.4),
                        new CountrySanitationStatistics(
                                "Costa Rica", 5100000, 94.7, 280000, 900, 240, 11.3),
                        new CountrySanitationStatistics(
                                "Cuba", 11200000, 89.1, 400000, 700, 250, 13.3),
                        new CountrySanitationStatistics(
                        ...
                        new CountrySanitationStatistics(
                                "Panamá", 4350000, 92.3, 380000, 209, 89, 17.1),
                        new CountrySanitationStatistics(
                                "Paraguay", 6700000, 68.4, 1200000, 217, 98, 11.2),
                        new CountrySanitationStatistics(
                                "Perú", 33700000, 84.7, 1700000, 3807, 1230, 16.),
                        new CountrySanitationStatistics(
